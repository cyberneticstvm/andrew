...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-12 text-center">
            ...
            <span style="background-color: #a8d18d;">&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="font-family: text">&nbsp;Vision&nbsp;&nbsp;&nbsp;&nbsp;</span>
            <span style="background-color: #4472c8;">&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="font-family: text">&nbsp;Action</span>
        </div>
    </div>
    <div class="row">
        <div class="col page">
        ...
        <div class="col page">
            ...
            <div class="call" style="margin-bottom: 30px;"><a href="https://mx.andrewlord.com.au/quiz-trainings" target="_blank">GET THE TRAINING</a></div>
        </div>
    </div>
    <div class="br"></div>
    <div class="row">
